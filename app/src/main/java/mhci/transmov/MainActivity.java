...
public class MainActivity extends AppCompatActivity {
        ...
        capBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder
                        ...
                        .setPositiveButton(R.string.dialog_gallery, new DialogInterface.OnClickListener() {
                            @Override
    ...
    public void startCamera() {
        if (PermissionUtils.requestPermission(
            ...
            Log.i(TAG,"link is"+this.getApplicationContext().getPackageName() + ".provider");
            Uri photoUri = FileProvider.getUriForFile(MainActivity.this, this.getApplicationContext().getPackageName() + ".provider", getCameraFile());
    ...
    public void uploadImage(Uri uri) {
        ...
        if (uri != null) {
            try {
                ...
                Toast.makeText(this, R.string.image_error, Toast.LENGTH_LONG).show();
            }
        } else {
            stop = true;
            timerCount = 0;
    ...
    public void showProgress(boolean bool){
        if(bool){
            ...
            progress.setMessage("Please wait while image is being processed...");
